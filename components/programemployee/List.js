...
import { list, reset } from "../../actions/programemployee/list";
import { success } from "../../actions/programemployee/delete";
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.programemployeeShow({ id });
  }
      ...
      <ListItem
        ...
        subtitle={
          <View>
            ...
            <View style={viewList}>
              <Text style={listRowLeft}>employee_num: </Text>
              <Text style={[listRowRight, { fontWeight: "bold" }]}>
                {item["employee_num"]}
              </Text>
            </View>
            <View style={viewList}>
              <Text style={listRowLeft}>start_date: </Text>
              <Text style={[listRowRight, { fontWeight: "bold" }]}>
                {item["start_date"]}
              </Text>
            </View>
            <View style={viewList}>
              <Text style={listRowLeft}>employeeNum: </Text>
              <Text style={[listRowRight, { fontWeight: "bold" }]}>
                {item["employeeNum"]}
              </Text>
            </View>
...
const mapStateToProps = (state) => {
  const { retrieved, error, loading, eventSource } = state.programemployee.list;
