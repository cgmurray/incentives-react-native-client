...
import { retrieve, reset } from "../../actions/employer/show";
import { del, loading, error } from "../../actions/employer/delete";
import { list } from "../../actions/employer/list";
    ...
    return (
      <View style={styles.actionStyle}>
        <SocialIcon
          ...
          type="plus-circle"
          iconColor="#3faab4"
          onPress={() => Actions.employerCreate()}
        />
        <SocialIcon
          iconSize={34}
          type="edit"
          iconColor="#3faab4"
          onPress={() => Actions.employerUpdate({ id })}
        />
        <SocialIcon
          iconSize={34}
          type="minus-circle"
          ...
          {item && (
            <Card title="Employer">
              <List title="title">
                ...
                {Show.renderRow("label", item["label"])}
              </List>
            </Card>
          )}
...
const mapStateToProps = (state) => {
  return {
    error: state.employer.show.error,
    loading: state.employer.show.loading,
    retrieved: state.employer.show.retrieved,
    deleteError: state.employer.del.error,
    deleteLoading: state.employer.del.loading,
