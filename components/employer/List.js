...
import { list, reset } from "../../actions/employer/list";
import { success } from "../../actions/employer/delete";
      ...
      <ListItem
        ...
        subtitle={
          <View>
            ...
            <View style={viewList}>
              <Text style={listRowLeft}>label: </Text>
              <Text style={[listRowRight, { fontWeight: "bold" }]}>
                {item["label"]}
              </Text>
            </View>
...
const mapStateToProps = (state) => {
  const { retrieved, error, loading, eventSource } = state.employer.list;
