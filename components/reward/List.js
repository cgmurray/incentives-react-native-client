...
import { list, reset } from "../../actions/reward/list";
import { success } from "../../actions/reward/delete";
      ...
      <ListItem
        ...
        subtitle={
          <View>
            ...
            <View style={viewList}>
              <Text style={listRowLeft}>cost: </Text>
              <Text style={[listRowRight, { fontWeight: "bold" }]}>
                {item["cost"]}
              </Text>
            </View>
...
const mapStateToProps = (state) => {
  const { retrieved, error, loading, eventSource } = state.reward.list;
