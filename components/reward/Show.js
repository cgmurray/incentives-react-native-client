...
import { retrieve, reset } from "../../actions/reward/show";
import { del, loading, error } from "../../actions/reward/delete";
import { list } from "../../actions/reward/list";
    ...
    return (
      <View style={styles.actionStyle}>
        <SocialIcon
          ...
          type="plus-circle"
          iconColor="#3faab4"
          onPress={() => Actions.rewardCreate()}
        />
        <SocialIcon
          iconSize={34}
          type="edit"
          iconColor="#3faab4"
          onPress={() => Actions.rewardUpdate({ id })}
        />
        <SocialIcon
          iconSize={34}
          type="minus-circle"
...
const mapStateToProps = (state) => {
  return {
    error: state.reward.show.error,
    loading: state.reward.show.loading,
    retrieved: state.reward.show.retrieved,
    deleteError: state.reward.del.error,
    deleteLoading: state.reward.del.loading,
