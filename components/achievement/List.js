...
import { list, reset } from "../../actions/achievement/list";
import { success } from "../../actions/achievement/delete";
...
const mapStateToProps = (state) => {
  const { retrieved, error, loading, eventSource } = state.achievement.list;
