...
import { retrieve, reset } from "../../actions/achievement/show";
import { del, loading, error } from "../../actions/achievement/delete";
import { list } from "../../actions/achievement/list";
    ...
    return (
      <View style={styles.actionStyle}>
        <SocialIcon
          ...
          type="plus-circle"
          iconColor="#3faab4"
          onPress={() => Actions.achievementCreate()}
        />
        <SocialIcon
          iconSize={34}
          type="edit"
          iconColor="#3faab4"
          onPress={() => Actions.achievementUpdate({ id })}
        />
        <SocialIcon
          iconSize={34}
          type="minus-circle"
...
const mapStateToProps = (state) => {
  return {
    error: state.achievement.show.error,
    loading: state.achievement.show.loading,
    retrieved: state.achievement.show.retrieved,
    deleteError: state.achievement.del.error,
    deleteLoading: state.achievement.del.loading,
