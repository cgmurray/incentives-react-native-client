...
import { retrieve, reset } from "../../actions/incentivemanagingpartner/show";
import {
  del,
  loading,
  error,
} from "../../actions/incentivemanagingpartner/delete";
import { list } from "../../actions/incentivemanagingpartner/list";
    ...
    return (
      <View style={styles.actionStyle}>
        <SocialIcon
          ...
          type="plus-circle"
          iconColor="#3faab4"
          onPress={() => Actions.incentivemanagingpartnerCreate()}
        />
        <SocialIcon
          iconSize={34}
          type="edit"
          iconColor="#3faab4"
          onPress={() => Actions.incentivemanagingpartnerUpdate({ id })}
        />
        <SocialIcon
          iconSize={34}
          type="minus-circle"
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <ScrollView>
          {item && (
            <Card title="IncentiveManagingPartner">
              <List title="title">
...
const mapStateToProps = (state) => {
  return {
    error: state.incentivemanagingpartner.show.error,
    loading: state.incentivemanagingpartner.show.loading,
    retrieved: state.incentivemanagingpartner.show.retrieved,
    deleteError: state.incentivemanagingpartner.del.error,
    deleteLoading: state.incentivemanagingpartner.del.loading,
