...
import { list, reset } from "../../actions/incentivemanagingpartner/list";
import { success } from "../../actions/incentivemanagingpartner/delete";
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.incentivemanagingpartnerShow({ id });
  }
...
const mapStateToProps = (state) => {
  const {
    ...
    loading,
    eventSource,
  } = state.incentivemanagingpartner.list;
