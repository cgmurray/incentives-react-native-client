...
import { retrieve, reset } from "../../actions/userprogramemployee/show";
import { del, loading, error } from "../../actions/userprogramemployee/delete";
import { list } from "../../actions/userprogramemployee/list";
    ...
    return (
      <View style={styles.actionStyle}>
        <SocialIcon
          ...
          type="plus-circle"
          iconColor="#3faab4"
          onPress={() => Actions.userprogramemployeeCreate()}
        />
        <SocialIcon
          iconSize={34}
          type="edit"
          iconColor="#3faab4"
          onPress={() => Actions.userprogramemployeeUpdate({ id })}
        />
        <SocialIcon
          iconSize={34}
          type="minus-circle"
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <ScrollView>
          {item && (
            <Card title="UserProgramEmployee">
...
const mapStateToProps = (state) => {
  return {
    error: state.userprogramemployee.show.error,
    loading: state.userprogramemployee.show.loading,
    retrieved: state.userprogramemployee.show.retrieved,
    deleteError: state.userprogramemployee.del.error,
    deleteLoading: state.userprogramemployee.del.loading,
