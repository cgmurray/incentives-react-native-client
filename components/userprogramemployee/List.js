...
import { list, reset } from "../../actions/userprogramemployee/list";
import { success } from "../../actions/userprogramemployee/delete";
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.userprogramemployeeShow({ id });
  }
...
const mapStateToProps = (state) => {
  const {
    ...
    loading,
    eventSource,
  } = state.userprogramemployee.list;
