...
import { list, reset } from "../../actions/healthmetriclog/list";
import { success } from "../../actions/healthmetriclog/delete";
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.healthmetriclogShow({ id });
  }
...
const mapStateToProps = (state) => {
  const { retrieved, error, loading, eventSource } = state.healthmetriclog.list;
