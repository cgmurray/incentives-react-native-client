...
import { list, reset } from "../../actions/birth/list";
import { success } from "../../actions/birth/delete";
      ...
      <ListItem
        ...
        subtitle={
          <View>
            ...
            <View style={viewList}>
              <Text style={listRowLeft}>stats: </Text>
              <Text style={[listRowRight, { fontWeight: "bold" }]}>
                {item["stats"]}
              </Text>
            </View>
...
const mapStateToProps = (state) => {
  const { retrieved, error, loading, eventSource } = state.birth.list;
