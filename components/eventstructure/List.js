...
import { list, reset } from "../../actions/eventstructure/list";
import { success } from "../../actions/eventstructure/delete";
      ...
      <ListItem
        ...
        subtitle={
          <View>
            ...
            <View style={viewList}>
              <Text style={listRowLeft}>is_birth: </Text>
              <Text style={[listRowRight, { fontWeight: "bold" }]}>
                {item["is_birth"]}
              </Text>
            </View>
            <View style={viewList}>
              <Text style={listRowLeft}>isBirth: </Text>
              <Text style={[listRowRight, { fontWeight: "bold" }]}>
                {item["isBirth"]}
              </Text>
            </View>
...
const mapStateToProps = (state) => {
  const { retrieved, error, loading, eventSource } = state.eventstructure.list;
