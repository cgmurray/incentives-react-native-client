...
import { retrieve, reset } from "../../actions/incentive/show";
import { del, loading, error } from "../../actions/incentive/delete";
import { list } from "../../actions/incentive/list";
    ...
    return (
      <View style={styles.actionStyle}>
        <SocialIcon
          ...
          type="plus-circle"
          iconColor="#3faab4"
          onPress={() => Actions.incentiveCreate()}
        />
        <SocialIcon
          iconSize={34}
          type="edit"
          iconColor="#3faab4"
          onPress={() => Actions.incentiveUpdate({ id })}
        />
        <SocialIcon
          iconSize={34}
          type="minus-circle"
...
const mapStateToProps = (state) => {
  return {
    error: state.incentive.show.error,
    loading: state.incentive.show.loading,
    retrieved: state.incentive.show.retrieved,
    deleteError: state.incentive.del.error,
    deleteLoading: state.incentive.del.loading,
