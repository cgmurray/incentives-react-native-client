...
import { list, reset } from "../../actions/incentive/list";
import { success } from "../../actions/incentive/delete";
...
const mapStateToProps = (state) => {
  const { retrieved, error, loading, eventSource } = state.incentive.list;
