...
import { retrieve, reset } from "../../actions/earnedachievement/show";
import { del, loading, error } from "../../actions/earnedachievement/delete";
import { list } from "../../actions/earnedachievement/list";
    ...
    return (
      <View style={styles.actionStyle}>
        <SocialIcon
          ...
          type="plus-circle"
          iconColor="#3faab4"
          onPress={() => Actions.earnedachievementCreate()}
        />
        <SocialIcon
          iconSize={34}
          type="edit"
          iconColor="#3faab4"
          onPress={() => Actions.earnedachievementUpdate({ id })}
        />
        <SocialIcon
          iconSize={34}
          type="minus-circle"
...
const mapStateToProps = (state) => {
  return {
    error: state.earnedachievement.show.error,
    loading: state.earnedachievement.show.loading,
    retrieved: state.earnedachievement.show.retrieved,
    deleteError: state.earnedachievement.del.error,
    deleteLoading: state.earnedachievement.del.loading,
