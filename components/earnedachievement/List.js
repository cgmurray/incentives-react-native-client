...
import { list, reset } from "../../actions/earnedachievement/list";
import { success } from "../../actions/earnedachievement/delete";
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.earnedachievementShow({ id });
  }
