...
import { retrieve, reset } from "../../actions/incentiveprogram/show";
import { del, loading, error } from "../../actions/incentiveprogram/delete";
import { list } from "../../actions/incentiveprogram/list";
    ...
    return (
      <View style={styles.actionStyle}>
        <SocialIcon
          ...
          type="plus-circle"
          iconColor="#3faab4"
          onPress={() => Actions.incentiveprogramCreate()}
        />
        <SocialIcon
          iconSize={34}
          type="edit"
          iconColor="#3faab4"
          onPress={() => Actions.incentiveprogramUpdate({ id })}
        />
        <SocialIcon
          iconSize={34}
          type="minus-circle"
...
const mapStateToProps = (state) => {
  return {
    error: state.incentiveprogram.show.error,
    loading: state.incentiveprogram.show.loading,
    retrieved: state.incentiveprogram.show.retrieved,
    deleteError: state.incentiveprogram.del.error,
    deleteLoading: state.incentiveprogram.del.loading,
