...
import { list, reset } from "../../actions/incentiveprogram/list";
import { success } from "../../actions/incentiveprogram/delete";
...
class ListComponent extends Component {
  ...
  static show(id) {
    Actions.incentiveprogramShow({ id });
  }
